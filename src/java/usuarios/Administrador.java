...
public class Administrador extends Usuario {
    ...
    public void createExercise(String code, String title, String desc, String concept, String resources, String type, String olymp, String itinerario) throws JSchException, SQLException {
        // Valores para conexión a MV remota
        String sshHost = "10.6.130.204";
        String sshUser = "usuario";
        String sshPassword = "Usuario";
        ...
        String sql = "INSERT INTO T_EJERCICIOS VALUES ('" + code + "', '" + title + "', '" + desc + "', '" + concept + "', '" + resources + "', '" + type + "', '" + olymp + "', '" + itinerario + "');";
        int rowsAffected = stmt.executeUpdate(sql);
