...
public class CheckItOrgAssignationsFrame extends JFrame implements Borders, Fonts, Icons, MouseListener {
    // Paneles
    JPanel upperPanel;
    ...
    public CheckItOrgAssignationsFrame(Admin administrador) throws JSchException, SQLException {
        ...
        // Columna de editar
        tabla.getColumnModel().getColumn(modeloTabla.getColumnCount() - 2).setCellRenderer(new CheckExOlympAssignationsFrame.ButtonPanelRenderer(2));
