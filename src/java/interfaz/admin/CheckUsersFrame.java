...
public class CheckUsersFrame extends JFrame implements Borders, Fonts, Icons, MouseListener {
    ...
    // Constructor
    public CheckUsersFrame(Admin administrador) throws JSchException, SQLException {
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        if (columna == tabla.getColumnCount() - 3) {
            new ModifyUserFrame(administrador, nombre, password, type);
            dispose();
